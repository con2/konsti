...
<En>
Konsti will show you a notification if you get a spot in a game in the lottery. You can also view these notifications on the <Link to={'/notifications'}>Notifications</Link> page.
</En>

<Fi>
<Link to={"/program/myprogram"}>Oma ohjelmani</Link> -näkymässä ja kaiken ohjelman
kaikki ilmoittautumistiedot näet puolestaan <Link to={"/results"}>Ilmoittautumistulokset</Link>-sivulta.
</Fi>

<En>
You can see all your sign-up results on the <Link to={'/program/myprogram'}>My Program page</Link> and all sign-ups to all program items on the <Link to={'/results'}>Sign-up Results</Link> page.
</En>
