...
Kompassi-kirjautumisen jälkeen voit luoda Konsti-käyttäjätunnuksen. Tähän tarvitset roolipelitiskiltä saatavan rekisteröintikoodin sekä joudut keksimään itsellesi käyttäjätunnuksen ja salasanan.
...
After Kompassi login, you can create a Konsti account. For this, you need a registration code from the RPG Desk and you will have come up with a username and password. After registering an account and logging in you can sign up to program.
