...
<Hitpoint>
Uuden käyttäjätilin luomiseen tarvitset rekisteröintikoodin, joita on saatavilla roolipelitiskiltä.
</Hitpoint>
</Fi>
...
<Hitpoint>
For creating an account, you will need a registration code, which you can get from the RPG Desk.
</Hitpoint>
...
<En>
You can create your account on the <Link to={'/registration'}>registration page</Link>.
</En>
