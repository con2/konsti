...
<En>
You can browse the <Link to={'/program/list'}>program list</Link> without logging in, but for registering to
program a user account is needed.
</En>
...
<Hitpoint>
Aikaisempien vuosien Konsti-käyttäjätilit eivät ole enää käytössä, vaan sinun on luotava uusi tili tämän vuoden tapahtumaa varten.
...
<Hitpoint>
Konsti accounts from previous years have been removed, so you will have to create a new one for this year's convention.
...
After Kompassi login, you can choose a Konsti username. After this, you can log in and sign up to program items.
...
<En>
The <Link to={'/program/list'}>program list page</Link> displays all program that uses Konsti for sign-ups.
...
<En>
On the page, you can also see other information, such as the duration of the program item and
its location. You can also see how many people have signed
...
<En>
Favoriting program items is a good way to keep track of program you find interesting. You can add a program item to your favorites by clicking on the heart icon in the upper right corner of a program item's info card. You can find your favorites in the <Link to={'/program/myprogram'}>My Program view</Link>.
</En>
...
<En>
If the sign-up period for a program item is ongoing, a sign-up button will be shown on the item's info card. You can cancel your sign-up on either the <Link to={'/program/myprogram'}>My Program page</Link> or the <Link to={'/program/list'}>program list</Link>.
</En>
