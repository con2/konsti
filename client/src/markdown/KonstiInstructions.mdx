...
Kompassi-kirjautumisen jälkeen voit rekisteröidä Konsti-käyttäjätunnuksen. Rekisteröitymiseen tarvitset roolipelitiskiltä saatavan rekisteröintikoodin sekä käyttäjätunnuksen ja salasanan.
