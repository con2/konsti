...
import { postGames, getGames } from 'server/features/game/gamesController';
import { postUser, getUser } from 'server/features/user/userController';
import { postLogin } from 'server/features/user/loginController';
import { postAssignment } from 'server/features/player-assignment/assignmentController';
import { postSignup } from 'server/features/user/signupController';
import { postFavorite } from 'server/features/user/favoriteController';
import { postHidden } from 'server/features/settings/hiddenController';
import { postSignupTime } from 'server/features/settings/signuptimeController';
import { postFeedback } from 'server/features/feedback/feedbackController';
import { getSettings } from 'server/features/settings/settingsController';
import { getResults } from 'server/features/results/resultsController';
import { postGroup, getGroup } from 'server/features/user/groupController';
import { toggleAppOpen } from 'server/features/settings/toggleAppOpenController';
